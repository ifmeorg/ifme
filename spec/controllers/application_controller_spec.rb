...
describe ApplicationController do
  ...
  describe 'moments_stats' do
    ...
    it 'has more than one moment created this month' do
      ...
      expect(controller.moments_stats).to eq('<div class="center" class="stats">You have written a <strong>total</strong> of <strong>2</strong> moments.</div>')
    end
    ...
    it 'has more than one moment created on different months' do
      ...
      expect(controller.moments_stats).to eq('<div class="center" class="stats">You have written a <strong>total</strong> of <strong>2</strong> moments. This <strong>month</strong> you wrote <strong>1</strong> moment.</div>')

      new_moment3 = create(:moment, user_id: user1.id)

      expect(controller.moments_stats).to eq('<div class="center" class="stats">You have written a <strong>total</strong> of <strong>3</strong> moments. This <strong>month</strong> you wrote <strong>2</strong> moments.</div>')
    end
  end
end
