...
RSpec.describe 'Membership', type: :request do
  ...
  describe '#kick' do
    context 'when current_user is a leader' do
      let!(:group_leader) { create :group_member, user_id: current_user.id, leader: true }
      let!(:group) { group_leader.group }
    ...
    context 'when current_user is not a leader' do
      let!(:group_member) { create :group_member, user_id: current_user.id, leader: false }
  ...
  describe '#leave' do
    context 'when current_user is not a leader' do
      ...
      let!(:another_member) { create :group_member, user_id: current_user.id, leader: false }
