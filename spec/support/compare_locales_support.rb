...
module CompareLocalesSupport
  ...
  LOCALES_FILES = {
    ...
    devise_vietnamese: "#{LOCALES_DIR}/devise.vn.yml",
    ...
    devise_invitable_vietnamese: "#{LOCALES_DIR}/devise_invitable.vn.yml",
    ...
    kaminari_vietnamese: "#{LOCALES_DIR}/kaminari.vn.yml"
  }.freeze
