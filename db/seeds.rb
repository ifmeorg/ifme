...
user1_trigger1 = Trigger.create(userid: user1.id, category: Array.new(1, user1_category1.id), mood: [user1_mood1.id, user1_mood2.id], name: 'Presentation for ENGL 101', why: 'I am presenting in front of my classmates and I am worried I will make a fool out of myself', viewers: user1_allies.allies)
user1_trigger1_comment = Comment.create(comment_type: 'trigger', commented_on: user1_trigger1.id, comment_by: user2.id, comment: "Good luck on the presentation! Just pretend everyone is in underpants :)")
...
user2_trigger1 = Trigger.create(userid: user2.id, category: Array.new(1, user2_category1.id), mood: Array.new(1,user2_mood1.id), name: 'Thanksgiving Dinner', why: 'He kept asserting to everyone that I was immature and he always did everything for me.', viewers: user2_allies.allies)
user2_trigger1_comment = Comment.create(comment_type: 'trigger', commented_on: user2_trigger1.id, comment_by: user1.id, comment: "You should talk to him one-on-one and tell him how you feel!")