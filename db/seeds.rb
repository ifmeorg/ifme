...
user1_meeting1 = Meeting.create(name: 'Meeting #1: Self-care', description: 'This week we will be talking about what we can do to adequately self-care during exams', location: 'http://SomeGoogleHangoutURL', date: 'May 1, 2015', time: '6:00 pm EST', maxmembers: 5, groupid: user1_group1.id)
user1_meeting1_member1 = MeetingMember.create(meetingid: user1_meeting1.id, userid: user1.id, leader: true)
user1_meeting2 = Meeting.create(name: 'Meeting #2: Exposure', description: 'This week we will be talking about how to expose ourselves to stressors', location: '1 Yonge St, Toronto, Canada', date: 'May 1, 2015', time: '6:00 pm EST', maxmembers: 0, groupid: user1_group1.id)
