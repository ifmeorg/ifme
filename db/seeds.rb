...
user1_moment1_comment = Comment.create(comment_type: 'moment', commented_on: user1_moment1.id, user_id: user2.id, comment: "Good luck on the presentation! Just pretend everyone is in underpants :)", visibility: 'private')
...
user2_moment1_comment = Comment.create(comment_type: 'moment', commented_on: user2_moment1.id, user_id: user1.id, comment: "You should talk to him one-on-one and tell him how you feel!", visibility: 'all')
