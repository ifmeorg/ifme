...
describe('Resource', () => {
  it('renders with neither tags nor author', () => {
    let wrapper = shallow(
      <Resource title={TITLE} link={URL} />,
    );
    expect(wrapper.find('.author').exists()).toEqual(false);
    expect(wrapper.find('.tags').exists()).toEqual(false);

    wrapper = shallow(
      <Resource title={TITLE} link={URL} tags={TAGS} />,
    );
    expect(wrapper.find('.author').exists()).toEqual(false);
    expect(wrapper.find('.tags').exists()).toEqual(false);

    wrapper = shallow(
      <Resource title={TITLE} link={URL} author={AUTHOR} />,
    );
    expect(wrapper.find('.author').exists()).toEqual(false);
    expect(wrapper.find('.tags').exists()).toEqual(false);
  ...
  it('renders with tags and author', () => {
    ...
    wrapper = shallow(
      <Resource title={TITLE} link={URL} external author={AUTHOR} tagged tags={TAGS} />,
    );
    expect(wrapper.find('.author').exists()).toEqual(true);
    expect(wrapper.find('.author').text()).toEqual(AUTHOR);
    expect(wrapper.find('.tags').exists()).toEqual(true);
    ...
    wrapper = shallow(
      <Resource title={TITLE} link={URL} external author={AUTHOR} tagged tags={EMPTY_TAGS} />,
    );
    expect(wrapper.find('.author').exists()).toEqual(true);
    expect(wrapper.find('.author').text()).toEqual(AUTHOR);
    expect(wrapper.find('.tags').exists()).toEqual(true);
