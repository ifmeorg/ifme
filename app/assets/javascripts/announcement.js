...
function translationsAnnouncement() {
  if ($("body").hasClass("pages home") && $("html").attr("lang") === "en") {
    $("#announcement").html(
      'More communities need mental health support. Our site is now available in <span id="translations_anchor" class="anchor">Español, Filipino, Italiano, Nederlands, Norsk, Português and Svenska</span>!'
    );
    showAnnouncement();
  }
}
