class PagesController < ApplicationController
  ...
  def contributors
    @blurbs = [
      ...
      {name: 'Nagma Kapoor', image: '/assets/contributors/nagma_kapoor.png', profile: "I have a B.A in Neurobiology from Rutgers University and I am pursuing a 2nd BSc. in Computer Science from Ryerson University. Mental health is a personal topic but good mental health relies on support, and through my interdisciplinary background I hope to bring my unique perspective here. Mental illness has been minimized in my community as a South Asian. You hear stories of family or friends in whispers. Only within my generation onward, there has been a minor shift, and I hope to see it open further. Personally, I have learnt to silently cope and create methods to keep my trajectory towards success without alerting anyone. Which is why I understand the need for an open-source project like if me. Sometimes, you need support from accepting family or friends without the eyes of an entire community on you. I think if me provides us with a safe space that extends out from our own selves and into the few that we trust. Building a closed community, that is free and open to individuals from all backgrounds, is a necessity. Access to mental health and resources need to reach those who need it most, and having an open source platform has been vital for it.", location: 'Toronto, Canada', link_name: 'nagmak', link: 'https://nagmak.github.io/', social: 'globe'}
    ]
