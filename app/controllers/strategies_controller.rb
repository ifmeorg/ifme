class StrategiesController < ApplicationController
  ...
  def new
    ...
    @strategy.build_selfcare_reminder
  ...
  def edit
    StrategyEmailReminder.find_or_initialize_by(strategy_id: @strategy.id)
    SelfcareReminder.find_or_initialize_by(strategy_id: @strategy.id)
  ...
  def strategy_params
    ...
    params.require(:strategy).permit(:name, :description, :userid, :comment, :self_care_strategy, {:category => []}, {:viewers => []}, strategy_email_reminder_attributes: [:name, :active])
  end
